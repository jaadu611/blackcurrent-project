      ...
      <section>
        <div className="flex flex-col md:flex-row justify-between items-end gap-8">
          ...
          >
            ...
            <h1 className="text-6xl font-black tracking-tighter text-on-surface mb-2">Dr. Eleanor Vance</h1>
            <p className="text-xl text-outline/80 max-w-2xl leading-relaxed">
              Academic Lead at <span className="text-primary">Oakridge Academy</span>. 
