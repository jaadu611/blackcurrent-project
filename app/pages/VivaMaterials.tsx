...
import { Plus, Edit, Trash2, Play, Users, Check, Clock, AlertCircle, Download } from "lucide-react";
    ...
    questions: [
      {
        ...
        expectedAnswer: "An object at rest stays at rest and an object in motion stays in motion with the same speed and direction unless acted upon by an unbalanced force.",
        points: 10,
      },
      {
        id: "q2",
        question: "Define velocity and explain how it differs from speed.",
        expectedAnswer: "Velocity is the rate of change of displacement. It is a vector quantity (has direction), while speed is a scalar quantity (magnitude only).",
        points: 10,
      },
    ],
  },
    ...
    questions: [
      {
        ...
        expectedAnswer: "A tabular arrangement of chemical elements organized by atomic number, electron configuration, and recurring chemical properties.",
        points: 10,
      },
    ],
  },
...
export default function VivaMaterials() {
  ...
  const handleDeleteQuestion = (questionId: string) => {
    ...
    const questionToDelete = selectedPaper.questions.find(q => q.id === questionId);
  ...
  const handleImportQuiz = () => {
    ...
    const questions: VivaQuestion[] = Array.from({ length: selectedQuiz.questionsCount }, (_, i) => ({
      id: `q${Date.now()}-${i}`,
    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-600">
          Create viva papers, manage questions, and conduct live oral examinations
        </p>
      </div>
              ...
              <Dialog open={isImportQuizOpen} onOpenChange={setIsImportQuizOpen}>
                ...
                <DialogContent>
                    ...
                    {selectedQuizId && (
                      <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <p className="text-sm text-blue-900">
                          {availableQuizzes.find(q => q.id === selectedQuizId)?.questionsCount} questions will be imported with 10 points each
                        </p>
                      </div>
                    )}
                  </div>
                  <DialogFooter>
                    ...
                    <Button onClick={handleImportQuiz} disabled={!selectedQuizId}>
                      Import Quiz
                    </Button>
                  </DialogFooter>
                </DialogContent>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-2">{paper.subject}</p>
                    ...
                    <Badge variant={selectedPaper?.id === paper.id ? "default" : "outline"}>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    {selectedPaper.totalQuestions} questions • {selectedPaper.totalPoints} total points
                  </CardDescription>
                </div>
                    ...
                    <div className="space-y-4 py-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setNewQuestion({ ...newQuestion, points: parseInt(e.target.value) || 0 })
                          }
                        />
                      </div>
                    </div>
              ...
              <div className="space-y-4 py-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setEditingQuestion({ ...editingQuestion, expectedAnswer: e.target.value })
                    }
                    rows={4}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditingQuestion({ ...editingQuestion, points: parseInt(e.target.value) || 0 })
                    }
                  />
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    {mockClasses.find(c => c.id === activeVivaClass)?.name} • {selectedPaper.title}
                  </CardDescription>
                </div>
            ...
            <CardContent>
                  ...
                  <TableBody>
                    {students.map((student) => (
                      <TableRow key={student.id}>
                        ...
                        <TableCell>
                          {student.status === "in-progress" && student.currentQuestion
              ...
              <div className="mt-4 flex justify-end">
                <Button onClick={handleEvaluateAll} size="lg">
